...
docker run -d --name test-postgres --network kafka_default --env-file ../.env.test postgres:latest
...
docker run --name url-app-test --rm --network kafka_default --env-file ../.env.test -v \
...
docker run -d --name url-app-test --network kafka_default --env-file ../.env.test url-app-test
